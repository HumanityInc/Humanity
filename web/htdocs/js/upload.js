...
function InitUploadFile(container, browse_button, drop_element, cb_img_url, cb_error, cb_start, cb_progress)
{
	DestroyUploadImg();
	...
	uploader.bind('FileUploaded', function(up, file, res) {
		...
		if (res.status == 200) {
			...
			try {
				...
				if (cb_img_url) cb_img_url(response.filelink, response.poster, file);
			}
			catch(e) {}
		}
		else {
